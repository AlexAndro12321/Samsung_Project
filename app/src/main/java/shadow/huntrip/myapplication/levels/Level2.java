...
public class Level2 extends AppCompatActivity
{
    ...
    private void InitializeExplainDialog()
    {
        ...
        previewImg.setImageResource(R.drawable.soad_logo);

        TextView textView = _explainDialog.findViewById(R.id.dialogText);
        textView.setText(R.string.SOAD_text);
    }
    ...
    private void GetSongData()
    {
        try
        {
            _tempSounds = new ArrayList<>(Arrays.asList(getAssets().list("Level2_music")));

            for(int i = 0; i < _tempSounds.size(); i++)
                _tempSounds.set(i, "Level2_music/" + _tempSounds.get(i));
        }
        catch (IOException e)
        {
            e.printStackTrace();
    ...
    private void SelectRandomSong()
    {
        ...
        catch (Exception e)
        {
            if(_correctAnswersCounter >= 8 && _correctAnswersCounter <= 10)
            {
                ...
                CustomDialog.ShowPositiveDialog(this, Level3.class, this, _correctAnswersCounter);
            }
            else
            {
                switch(_correctAnswersCounter)
                {
                    case 0, 5, 6, 7 -> CustomDialog.ShowNegativeDialog(this, Level2.class, this, _correctAnswersCounter, "баллов");
                    case 1 -> CustomDialog.ShowNegativeDialog(this, Level2.class, this, _correctAnswersCounter, "балл");
                    case 2, 3, 4 -> CustomDialog.ShowNegativeDialog(this, Level2.class, this, _correctAnswersCounter, "балла");
